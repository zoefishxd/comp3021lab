...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		buttonLoad.setOnAction(new EventHandler<ActionEvent>(){
			...
			public void handle(ActionEvent event){
				...
				FileChooser.ExtensionFilter extFilter = new FileChooser.ExtensionFilter("Serialized Object File (*.ser, arg1)", "*.ser");
		...
		buttonSave.setOnAction(new EventHandler<ActionEvent>(){
			...
			public void handle(ActionEvent event){
				FileChooser fileChooser = new FileChooser();
				fileChooser.setTitle("Please Choose An File To Save Your NoteBook Object!");
		...
		buttonSearch.setOnAction(new EventHandler<ActionEvent>(){
			...
			public void handle(ActionEvent event){
				...
				List<Note> listOfNotes = noteBook.searchNotes(currentSearch);
				List<Folder> listOfFolder = noteBook.getFolders();
				for(Folder f : listOfFolder){
					if(f.getName().equals(currentFolder)){
						//listOfNote.addAll(f.getNotes());
						
					}
				}
				//for(Note n : )
				updateListView(listOfNotes);
			}
		});
	...
	private VBox addVBox() {
		...
		buttonAddFolder.setPrefSize(150, 20);
	...
	private void updateListView(List<Note> listOfNote) {
		...
		buttonSaveNote.setOnAction(new EventHandler<ActionEvent>(){
			...
			public void handle(ActionEvent event){
				if (currentFolder.equals("-----")&&currentNote.equals("")){
					...
					for(Folder f : noteBook.getFolders()){
						if(f.getName().equals(currentFolder)){
							List<Note> listofnote = f.getNotes();
							for(Note n : listofnote){
								List<Note> textnote = new ArrayList<Note>();
